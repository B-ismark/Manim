...
- **Security & Privacy** → [audit/findings-security.md](findings-security.md) — 1 High, 3 Medium, 3 Low
- **Data & State Correctness** → [audit/findings-data.md](findings-data.md) — 2 High, 3 Medium, + ruled-out
- **Performance** → [audit/findings-performance.md](findings-performance.md) — 3 Medium, 1 Low (+ much ruled out)
- **UI / UX / Accessibility / Code** → [audit/findings-ui-code.md](findings-ui-code.md) — 1 High, 2 Medium, 4 Low
- **Visual** → [audit/findings-visual.md](findings-visual.md) — 1 Low (likely false positive)
