...
export const DATA_COLLECTED: { what: string; where: string; why: string }[] = [
  ...
  },
  {
    ...
    why: 'So you can rejoin a call from the home screen of any device you’re signed in on. Signing out clears this browser’s copy; removing a call from the list removes it from your account (a device that already has it keeps its own copy until you remove it there too), and calls not rejoined for 30 days are deleted.',
  },
  {
