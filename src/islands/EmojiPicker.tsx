...
export function EmojiPicker({ onSelect }: { onSelect: (emoji: string) => void }) {
  ...
  return (
    ...
    <div className="flex w-full flex-col gap-2 sm:w-[22rem]">
      ...
      <div
        className="grid h-[44dvh] grid-cols-[repeat(auto-fill,minmax(2.75rem,1fr))] content-start gap-1 overflow-y-auto overflow-x-hidden overscroll-contain sm:h-56 no-scrollbar"
      >
        {loading ? (
