 ...
 * navigator `devicechange` signal. On a loss we surface an actionable toast with
 * a one-tap re-acquire and report it so the failure rate is measurable.
 *
